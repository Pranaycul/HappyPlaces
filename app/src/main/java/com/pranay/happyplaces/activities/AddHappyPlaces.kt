...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       binding.toolbarAddPlace.setNavigationOnClickListener {
        ...
        // TODO (Step 5 : Assigning a click event listener to the save button.)
        // START
        binding.brnSave.setOnClickListener(this)
        // END
    }
            ...
            if (requestCode == GALLERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        // TODO (Step 7 : Let us make this uri path global so we can save it to our local database.)
                        // START
                        ...
                        binding.ivImage.setImageBitmap(selectedImageBitmap) // Set the selected image from GALLERY to imageView.
                    } catch (e: IOException) {
                        e.printStackTrace()
                ...
                // TODO (Step 8 : Let us also make this uri path global which we received from camera captured image so we can save it to our local database.)
                // START
                saveImageToInternalStorage =
                ...
                binding.ivImage.setImageBitmap(thumbnail) // Set to the imageView.
            }
